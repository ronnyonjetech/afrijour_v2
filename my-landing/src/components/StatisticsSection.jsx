...
const StatisticsSection = () => {
  ...
  const statisticsData = [
    { id: 1, icon: <BsJournals />, value: 2004, label: translations.journals_stat },
    { id: 2, icon: <FaLaptop />, value: 377, label: translations.thematic_areas_stat },
    { id: 3, icon: <FaClock />, value: 41, label: translations.countries_stat },
    { id: 4, icon: <IoLanguage />, value: 64, label: translations.languages_stat },
    { id: 5, icon: <LuListOrdered />, value: 7692, label: translations.volumes_stat },
    { id: 6, icon: <FaFile />, value: 14753, label: translations.articles_stat },
    { id: 7, icon: <FaLaptop />, value: 11000, label: translations.abstracts_stat },
    { id: 8, icon: <FaLaptop />, value: 1000, label: translations.publishers_stat },
  ];
